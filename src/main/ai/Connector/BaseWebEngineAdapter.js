...
export default class BaseWebEngineAdapter {
    constructor() {}

    async search(searchString) {
        console.log('BaseSearchEngineAdapter search string', searchString);
    }

    async scrape(webUrl){
        console.log('BaseScrapeEngineAdapter scrape url', webUrl);
    }
}
