...
export function keyTap(key: string, delayGap?: number, modifier?: string | string[]) : void
export function keyToggle(key: string, down: string, delayGap?: number, modifier?: string | string[]) : void
